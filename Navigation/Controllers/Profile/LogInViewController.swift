...
class LogInViewController: UIViewController {
    ...
    private lazy var loginAndPasswordStackView: UIStackView = {
        ...
        loginAndPasswordStackView.layer.cornerRadius = 10
    ...
    @objc func keyboardAppeared(notification: NSNotification) {
        if let keyboard = (notification.userInfo?[UIResponder.keyboardFrameEndUserInfoKey] as? NSValue)?.cgRectValue {
            ...
            scrollView.contentInset.bottom = view.safeAreaInsets.bottom + keyboard.height + 20
        }
    }
    ...
    func setupViews() {
        ...
        let constraints = [
            ...
            logoImageVK.topAnchor.constraint(equalTo: customContainerView.topAnchor, constant: 120),
            ...
            loginAndPasswordStackView.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: 16),
            loginAndPasswordStackView.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: -16),
            loginAndPasswordStackView.topAnchor.constraint(equalTo: logoImageVK.bottomAnchor, constant: 120),
            loginAndPasswordStackView.heightAnchor.constraint(equalToConstant: 100),
            
            buttonLogIn.topAnchor.constraint(equalTo: loginAndPasswordStackView.bottomAnchor, constant: 16),
